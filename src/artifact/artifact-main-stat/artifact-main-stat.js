...
function ArtifactMainStat({ artifactType, artifactMainStatChangeCallback }) {
    ...
    const renderSpecificMainStat = (artifactType) => {
        ...
        return <MainStatSelect potentialStats={potentialStats} key={artifactType} artifactMainStatChangeCallback={artifactMainStatChangeCallback} disabled={artifactType === ""} />
    }
